...
export const en = {
  auth: {
    ...
    biometricFailedMessage: 'Biometric authentication was not successful. Please try again or sign in with your credentials.',
    biometricUnavailable: 'Biometric Unavailable',
    biometricUnavailableMessage: 'Your device does not have biometric hardware or no biometrics are enrolled. Please sign in with your credentials.',
    biometricNotSetup: 'Biometric Login Not Setup',
    biometricNotSetupMessage: 'Please sign in first and enable Biometric Lock in Settings to use biometric login.',
    biometricNeedsSignIn: 'Please sign in once with your credentials to enable biometric login.',
    biometricError: 'An error occurred during biometric authentication. Please sign in normally.',
  },
  home: {
...
export const fr = {
  auth: {
    ...
    biometricFailedMessage: "L'authentification biométrique n'a pas réussi. Veuillez réessayer ou vous connecter avec vos identifiants.",
    biometricUnavailable: 'Biométrie non disponible',
    biometricUnavailableMessage: "Votre appareil ne dispose pas de matériel biométrique ou aucune biométrie n'est enregistrée. Veuillez vous connecter avec vos identifiants.",
    biometricNotSetup: 'Connexion biométrique non configurée',
    biometricNotSetupMessage: "Veuillez d'abord vous connecter et activer le verrouillage biométrique dans les paramètres pour utiliser la connexion biométrique.",
    biometricNeedsSignIn: 'Veuillez vous connecter une fois avec vos identifiants pour activer la connexion biométrique.',
    biometricError: "Une erreur s'est produite lors de l'authentification biométrique. Veuillez vous connecter normalement.",
  },
  home: {
