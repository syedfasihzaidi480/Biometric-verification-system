...
async function registerRoutes() {
  ...
  for (const routeFile of routeFiles) {
    try {
      // Convert Windows paths to file:// URLs to handle special characters
          ...
          if (route[method]) {
            ...
            const handler: Handler = async (c) => {
              ...
              if (import.meta.env?.DEV) {
                const fileUrlDev = `file:///${routeFile.replace(/\\/g, '/')}?update=${Date.now()}`;
                const updatedRoute = await import(
                  /* @vite-ignore */ fileUrlDev
                );
...
// @ts-ignore - Vite-specific import.meta extensions
if (import.meta.env?.DEV) {
  // @ts-ignore - Vite-specific import.meta.glob
  import.meta.glob('../src/app/api/**/route.js', {
    eager: true,
  });
  // @ts-ignore - Vite-specific import.meta.hot
  if (import.meta.hot) {
    // @ts-ignore - Vite-specific import.meta.hot
