            ...
            <div className="flex gap-3">
              ...
              {isSuperAdmin && (
                <a
                  ...
                  className="inline-flex items-center px-4 py-2 border border-blue-300 bg-blue-50 rounded-md shadow-sm text-sm font-medium text-blue-700 hover:bg-blue-100"
                >
                  <Shield size={16} className="mr-2" />
                  DB Health
                </a>
