...
/**
 * Admin endpoint to retrieve face liveness images
 * GET /api/admin/face-images?userId=xxx
 */
export async function GET(request) {
  try {
    ...
    const collection = db.collection('face_liveness_images');
    ...
    console.error('Face images retrieval error:', error);
...
/**
 * Admin endpoint to retrieve a specific face image with image data
